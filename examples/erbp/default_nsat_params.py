...
rN_STATES = range(N_STATES)             # Number of states per neuron
rN_GROUPS = range(N_GROUPS)             # Number of parameters groups
rN_LRNGROUPS = range(N_LRNGROUPS)       # Number of learning parameters groups
