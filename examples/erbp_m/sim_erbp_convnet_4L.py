...
Connection(setup, pop_conv2, pop_conv3, 0).connect_conv2dbank(inputsize//stride2, N_FEAT1, N_FEAT2, stride1, ksize)
Connection(setup, pop_conv3, pop_conv4, 0).connect_conv2dbank(inputsize//stride2, N_FEAT2, N_FEAT2, stride2, ksize)
...
cx_p=Connection(setup, pop_err_pos, pop_conv1, 1)
cx_p.connect_shuffle(2000)
cx_n=Connection(setup, pop_err_neg, pop_conv1, 1)
cx_n.connect(cx_p.ptr_table, -cx_p.wgt_table)

cx_p=Connection(setup, pop_err_pos, pop_conv2, 1)
cx_p.connect_shuffle(2000)
cx_n=Connection(setup, pop_err_neg, pop_conv2, 1)
cx_n.connect(cx_p.ptr_table, -cx_p.wgt_table)

cx_p=Connection(setup, pop_err_pos, pop_conv3, 1)
cx_p.connect_shuffle(2000)
cx_n=Connection(setup, pop_err_neg, pop_conv3, 1)
cx_n.connect(cx_p.ptr_table, -cx_p.wgt_table)

cx_p=Connection(setup, pop_err_pos, pop_conv4, 1)
cx_p.connect_shuffle(2000)
cx_n=Connection(setup, pop_err_neg, pop_conv4, 1)
cx_n.connect(cx_p.ptr_table, -cx_p.wgt_table)
...
c_nsat_writer_train = nsat.C_NSATWriterMultithread(cfg_train, path=exp_name,
                                                   prefix='')
c_nsat_writer_train.write()

# c_nsat_writer_test = nsat.C_NSATWriter(cfg_test, path=exp_name_test,prefix='')
c_nsat_writer_test = nsat.C_NSATWriterMultithread(cfg_test, path=exp_name,
                                                  prefix='')
