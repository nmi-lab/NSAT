...
net_graph.create_connection(pop_conv2, pop_conv3, 0, connect_conv2dbank(inputsize//stride2, N_FEAT1, N_FEAT2, stride1, ksize))
net_graph.create_connection(pop_conv3, pop_conv4, 0, connect_conv2dbank(inputsize//stride2, N_FEAT2, N_FEAT2, stride2, ksize))
net_graph.create_connection(pop_conv4, pop_hid,   0, connect_random_uniform(low=-16, high=16))
