...
Connection(setup, pop_data, pop_conv1, 0).connect_conv2dbank(inputsize, Nchannel, N_FEAT1, stride, ksize)
Connection(setup, pop_conv1, pop_conv2, 0).connect_conv2dbank(inputsize//2, N_FEAT1, N_FEAT2, stride, ksize)
