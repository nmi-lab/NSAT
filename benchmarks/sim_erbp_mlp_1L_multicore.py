...
def erbp_mlp_1L_multicore():
    exp_name = '/tmp/mnist_mlp_1L_multicore'
    exp_name_test = '/tmp/mnist_mlp_1L_multicore_test/'
    ...
    pop_lab = net_graph.create_population(Population(name='lab',
                                                     ...
                                                     core=-1,
                                                     is_external=True))
    pop_hid = net_graph.create_population(Population(name='hid1',
                                                     n=Nh,
                                                     core=1,
    ...
    net_graph.create_connection(pop_data, pop_hid, 0,
